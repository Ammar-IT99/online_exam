...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  // 🔑 Register Method
  @override
  Future<ApiResult<AuthResultEntity>> register(String userName,
      String firstName,
      String lastName,
      String email,
      String password,
  ...
  // 🔑 SignIn Method
  @override
  Future<ApiResult<AuthResultEntity>> signIn(String email,
  ...
  @override
  Future<ApiResult<VerifyResetCodeEntity>> verifyResetCode(
  ...
  @override
  Future<ApiResult<ResetPasswordEntity>> resetPassword(String email,
  ...
  @override
  Future<ApiResult<List<GetAllSubjectsRequest>>> getAllSubjects(String name,
      String icon) async {
    final result = await apiService.getAllSubjects(name, icon);

    switch (result) {
      case Success(data: final List<GetAllSubjectsRequest> response):
        List<GetAllSubjectsRequest> entities = response.map((dto) =>
            dto.toGetAllSubjectsRequest()).toList();
